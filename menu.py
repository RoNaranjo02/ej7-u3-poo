    ...
    def opciones(self, listaAgentes):
        while self.__opcion != 9:
            ...
            if self.__opcion == 1:
                ...
                tipo = str(input("Ingrese el tipo de agente (docente, investigador, docente investigador, personal de apoyo): "))
                ...
                if tipo == "docente":
                    ...
                    agente = DocenteInvestigador(cuil,apellido,nombre,sueldobasico,antiguedad,carrera,cargo,catedra,areainvestigacion,tipoinvestigacion,categoriainvestigacion,importeextra)
                    listaAgentes.insertarElemento(posicion, agente)

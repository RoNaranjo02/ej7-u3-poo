...
class DocenteInvestigador(Docente, Investigador):
    ...
    def __init__(self, cuil='', apellido='', nombre='', sueldobasico=0, antiguedad=0, carrera='', cargo='', catedra='', areainvestigacion='',tipoinvestigacion='',categoriainvestigacion = '', importeextra = 0):
    ...
    def __str__(self):
        return super().__str__() + "\n Categoria: " + self.__categoria + " Importe extra por docencia e investigacion: $" + str(self.__extra)

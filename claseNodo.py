...
class Nodo:
    ...
    def toJSON(self):
        if isinstance(self.__agente, DocenteInvestigador):
            d = dict(tipo = "docenteinvestigador", cuil = self.__agente.getCuil(), apellido = self.__agente.getApellido(), nombre = self.__agente.getNombre(), sueldobasico = self.__agente.getSueldoBasico(), antiguedad = self.__agente.getAntiguedad(), carrera = self.__agente.getCarrera(), cargo = self.__agente.getCargo(), catedra = self.__agente.getCatedra(), areainvestigacion = self.__agente.getArea(), tipoinvestigacion = self.__agente.getTipo(), categoria = self.__agente.getCategoria(), importeextra = self.__agente.getExtra())
        elif isinstance(self.__agente, Docente):
            d = dict(tipo = "docente", cuil = self.__agente.getCuil(), apellido = self.__agente.getApellido(), nombre = self.__agente.getNombre(), sueldobasico = self.__agente.getSueldoBasico(), antiguedad = self.__agente.getAntiguedad(), carrera = self.__agente.getCarrera(), cargo = self.__agente.getCargo(), catedra = self.__agente.getCatedra())
        elif isinstance(self.__agente, Investigador):
            d = dict(tipo = "investigador", cuil = self.__agente.getCuil(), apellido = self.__agente.getApellido(), nombre = self.__agente.getNombre(), sueldobasico = self.__agente.getSueldoBasico(), antiguedad = self.__agente.getAntiguedad(), areainvestigacion = self.__agente.getArea(), tipoinvestigacion = self.__agente.getTipo())
        elif isinstance(self.__agente, PersonalApoyo):
            d = dict(tipo = "personalapoyo", cuil = self.__agente.getCuil(), apellido = self.__agente.getApellido(), nombre = self.__agente.getNombre(), sueldobasico = self.__agente.getSueldoBasico(), antiguedad = self.__agente.getAntiguedad(), categoria = self.__agente.getCategoria())
        return d